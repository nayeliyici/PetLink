...
class FormAdoption extends StatefulWidget {
  const FormAdoption({super.key});

  @override
  State<FormAdoption> createState() => _FormAdoptionState();
}

class _FormAdoptionState extends State<FormAdoption> {
  String _selectedOption = 'Tipo de casa';
  String _selectedOption2 = 'Casa con jardín';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const CustomTextField(label: "Dirección completa:"),
            const CustomTextField(label: "Ocupación:"),
            ...
            const CustomTextField(label: "¿Cuántas personas viven en tu casa?"),
            const SizedBox(height: 35),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
            ...
            const SizedBox(height: 35),
            const CustomTextField(label: "Edades"),
            const SizedBox(height: 30),
            const Divider(
                thickness: 2, color: Color.fromARGB(255, 114, 64, 253)),
            const SizedBox(height: 10),
            ...
            const SizedBox(height: 35),
            const CustomTextField(label: "¿Cuánto tiempo pasará sola la mascota?"),
            const SizedBox(height: 15),
            const CustomTextField(label: "¿Con qué frecuencia saldrá a pasear?"),
